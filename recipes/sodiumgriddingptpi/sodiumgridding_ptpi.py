...
# The OpenRecon packaging schema allows at most 14 label parameters. Machine-level
# ``maxcoils`` and ``maxworkers`` limits are therefore set on the container, but
# remain readable from a manually supplied JSON config.
