<XProtocol> 
{
  ...
  <ParamMap.""> 
  {
    ...
    <ParamMap."OpenRecon"> 
    {
      ...
      <ParamString."OpenReconAlgorithm">  { "neurodesk_openmsk_V0"  }
      <ParamArray."Parameters"> 
      {
        ...
        {  { "config"  } { "openmsk"  } }
        {  { "segmodel"  } { "acl_qdess_bone_july_2024"  } }
        { }
        { }
        { }
        { }
    ...
    <ParamMap."Properties"> 
    {
      ...
      <ParamMap."Queue"> 
      {
        ...
        <ParamString."ProtocolName">  { "wip_dess_CS"  }
      }
    }
  }
}
...
ulVersion	 = 	66110001
tSequenceFileName	 = 	"%CustomerSeq%\wip_GRE_3D_DRB_dess"
tProtocolName	 = 	"wip_dess_CS"
...
dAveragesDouble	 = 	1.0
lScanTimeSec	 = 	152
lTotalScanTimeSec	 = 	154
dRefSNR	 = 	58787.7538268
dRefSNR_VOI	 = 	58787.7538268
ulMotionCorr	 = 	1
ucCineMode	 = 	1
ucSequenceType	 = 	2
ucCoilCombineMode	 = 	2
...
lSilentPeriod	 = 	0
dOverallImageScaleFactor	 = 	0.0213333333333
...
sSliceArray.asSlice[0].dPhaseFOV	 = 	160.0
sSliceArray.asSlice[0].dReadoutFOV	 = 	160.0
sSliceArray.asSlice[0].sPosition.dSag	 = 	-71.0907170912
sSliceArray.asSlice[0].sPosition.dCor	 = 	-19.499943273
sSliceArray.asSlice[0].sPosition.dTra	 = 	89.4090807281
...
sPrepPulses.lFatWaterContrast	 = 	16
...
sAAInitialOffset.SliceInformation.sPosition.dSag	 = 	-71.0907170912
sAAInitialOffset.SliceInformation.sPosition.dCor	 = 	-19.499943273
sAAInitialOffset.SliceInformation.sPosition.dTra	 = 	89.4090807281
...
sWipMemBlock.tFree	 = 	"base64:eyJNb2RlbC5JRCI6NzcyfQ=="
