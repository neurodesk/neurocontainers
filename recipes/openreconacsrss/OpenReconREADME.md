...
`macros/openrecon/fire_poc.py` and Python dependencies from the recipe. Output
...
```sh
python macros/openrecon/tests/smoke_fire_poc.py
```
...
compatibility. The shared implementation is `macros/openrecon/fire_poc.py`.
