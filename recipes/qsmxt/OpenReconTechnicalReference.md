# QSMxT OpenRecon technical reference

Implementation details and benchmark results for developers and advanced users.
For scanner setup and usage, see the [user guide](OpenReconREADME.md).
